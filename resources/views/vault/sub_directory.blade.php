...
<div class="container">
    <div class="row justify-content-center">
        <div class="container-header">
            <label class="label-bold" id="div1">Vault 1</label>
      ...
      <div class="div-margin">
        ...
        <div class="col-md-1">
          <div style="align-items: center;text-align: center;">
            <a href="{{route('sub_sub_directory',[$foldername,$folders])}}" style="color: white">
        ...
        <div class="row" style="margin-top: 30px" style="margin-top: 30px" id="gridview">
          ...
          <div class="col-md-1" style="align-items: center;text-align: center;">
            @if($value->type == 'png' or $value->type == 'jpg') 
              ...
              <a target="_blank" href="{{ URL::to('/') }}/vault/{{$foldername}}/{{$image}}">
                 <img src="{{ URL::to('/') }}/vault/{{$foldername}}/{{$image}}" title="{{$value->name}}.{{$value->type}} , {{date('d-m-Y H:i', strtotime($value->updated_at))}}" style="height: 100px;width: 100px"> 
              </a>
      ...
      <div id="listview" style="display: none">
        ...
        <table class="table">
          ...
          <tbody>
              ...
              @foreach($folderarray as $key=>$level1)
               
              <tr>
                <td width="200px">{{$level1}} </td>
                                    ...
                                    <div class="modal-body">
                                      <form method="post" action="{{route('update-foldername')}}">
                                        ...
                                        <div class="mb-3">
                                          ...
                                          <input type="text" class="form-control" id="name" name="name" placeholder="Enter Category name" value="{{$level1}}" required>
                                        </div>

                                         
                                        <input type="hidden" name="sub_folders" value="2">
                                        <input type="hidden" name="old_name" value="{{$level1}}">
        ...
        <table class="table">
          ...
          <tbody>
              ...
              <tr>
                ...
                <td>
                  <a target="_blank" href="{{ URL::to('/') }}/vault/{{$foldername}}/{{$image}}"><button class="btn btn-sm btn-outline-secondary">View</button></a>
                  @if(Auth::user()->role_id == '1' OR Auth::user()->role_id == '2' OR Auth::user()->role_id == '3' OR Auth::user()->role_id == '6' OR Auth::user()->role_id == '9' OR Auth::user()->role_id == '10')
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                 <form action="{{ route('save_sub_directory_files') }}" method="POST" enctype="multipart/form-data">
                    @csrf
