      ...
      <div id="listview" style="display: none">
        ...
        <table class="table">
          ...
          <tbody>
              ...
              @foreach($folderarray as $key=>$level3)
               
              <tr>
                <td width="200px">{{$level3}} </td>
                                    ...
                                    <div class="modal-body">
                                      <form method="post" action="{{route('update-foldername')}}">
                                        ...
                                        <div class="mb-3">
                                          ...
                                          <input type="text" class="form-control" id="name" name="name" placeholder="Enter Category name" value="{{$level3}}" required>
                                        </div>

                                         
                                        <input type="hidden" name="sub_folders" value="4">
                                        <input type="hidden" name="old_name" value="{{$level3}}">
