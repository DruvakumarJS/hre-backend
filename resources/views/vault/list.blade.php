...
<div class="container">
    ...
    <div class="page-container">
      ...
      <div class="div-margin">
        ...
        <div class="col-md-1">
          <div style="align-items: center;text-align: center;">
            <a href="{{route('sub_directory',$folders)}}" style="color: white">
      ...
      <div class="div-margin">
        ...
        <div class="row" style="margin-top: 30px" id="gridview">
          ...
          <div class="col-md-1" style="align-items: center;text-align: center;">
            @if($value->type == 'png' or $value->type == 'jpg') 
              ...
              <a target="_blank" href="{{ URL::to('/') }}/vault/{{$image}}">
                 <img src="{{ URL::to('/') }}/vault/{{$image}}" title="{{$value->name}}.{{$value->type}} , {{date('d-m-Y H:i', strtotime($value->updated_at))}}" style="height: 100px;width: 100px">
              </a>
      ...
      <div id="listview" style="display: none">
        ...
        <table class="table">
          ...
          <tbody>
              ...
              @foreach($folderarray as $key=>$foldername)
               
              <tr>
                <td width="200px">{{$foldername}} </td>
                                    ...
                                    <div class="modal-body">
                                      <form method="post" action="{{route('update-foldername')}}">
                                        ...
                                        <div class="mb-3">
                                          ...
                                          <input type="text" class="form-control" id="name" name="name" placeholder="Enter Category name" value="{{$foldername}}" required>
                                        </div>

                                         
                                        <input type="hidden" name="sub_folders" value="1">
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                 <form action="{{ route('save_files') }}" method="POST" enctype="multipart/form-data">
                    @csrf
