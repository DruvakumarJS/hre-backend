            ...
            <label style="margin-top: 20px;">Dear All ,</label>
                 @if(!isset($pcn_data['old_data']))
                   <div style="margin-top: 20px">
                     <label>Please note that We have updated below mentioned Material Category in HRE Teams
</label>
                   </div>
                 @else
                 <div style="margin-top: 20px">
                 ...
                 @endif 
                 <label class="label-bold">Updated Details </label> 
                   <div style="margin-top: 20px;">
                     <label>Category Name : </label> <label class="label-bold">{{$pcn_data['new_data']['pcn']}}</label>
                  </div>
                   <div style="margin-top: 10px;">
                     <label>Category Code : </label> <label class="label-bold">{{$pcn_data['new_data']['brand']}}</label>
                  </div>
